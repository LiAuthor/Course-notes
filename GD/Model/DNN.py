...
def load_dataset():
    train_dataset = h5py.File('/home/yee/GraduationDesign/MakeSampleSet/Train_Set_cat_1.h5', "r")
    # your train set features
    train_set_x_orig = np.array(train_dataset["train_set_x"][:])
    train_set_y_orig = np.array(
        train_dataset["train_set_y"][:])  # your train set labels

    test_dataset = h5py.File('/home/yee/GraduationDesign/MakeSampleSet/Test_Set_cat_1.h5', "r")
...
def L_layer_model(X, Y, layers_dims, learning_rate=0.0075, num_iterations=5000, print_cost=False, isPlot=True):
    """
    ...
    if isPlot:
        ...
        plt.show()
    # 保存参数
    with open('Cat_parameters.pkl', 'wb') as f:
