...
def load_dataset():
    ...
    train_dataset = h5py.File(
        '/home/yee/Practive/DL_HomeWork/course1_week2/datasets/train_catvnoncat.h5', "r")
    #train_dataset = h5py.File('../DataSet/Train_Set_cat_1.h5', "r")
    ...
    test_dataset = h5py.File(
        '/home/yee/Practive/DL_HomeWork/course1_week2/datasets/test_catvnoncat.h5', "r")
    #test_dataset = h5py.File('../DataSet/Test_Set_cat_1.h5', "r")
